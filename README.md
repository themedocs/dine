...
Source for <https://themedocs.github.io/dine/> — the documentation for the Dine WordPress theme.
...
```
content/index.md          the dine docs home
content/<section>/<page>.md
docs/assets/              screenshots, referenced as /dine/assets/…
